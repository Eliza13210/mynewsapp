...
public class SearchActivityTest {
    ...
    @Test public void searchActivityTest() {
    ...
    allOf(withId(R.id.cbScience), withText("Science"),
    childAtPosition(
    childAtPosition(
    withClassName(is("android.widget.LinearLayout")),
    0),
    ...
    allOf(withId(R.id.query), withText("cat"),
    childAtPosition(
    childAtPosition(
    withClassName(is("android.widget.LinearLayout")),
    0),
